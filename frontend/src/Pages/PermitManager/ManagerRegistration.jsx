...
function ManagerRegistration() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      axios
        .put(`http://localhost:3001/PermitManager/${id}`, formData)
        .then((res) => {
          console.log(res);
          if (res.data === "permit_success") {
            ...
            Modal.success({
              title: "Successful !",
              content: "আপনি সফলভাবে ম্যানেজার অনুমোদন করেছেন",
              onOk: () => {
                toggleButton();
              },
            });
        ...
        >
          <form className={styles.managerForm}>
            ...
            <div className={styles.managerContent} id="managerContent">
              ...
              <div className={styles.managerInfield}></div>
            ...
            <div className={styles.permitButtonContainer}>
              <button
                type="submit"
                className={styles.permitManagerButton}
              ...
              <button
                type="submit"
                className={styles.notpermitManagerButton}
