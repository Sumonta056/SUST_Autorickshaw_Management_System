  ...
  const handleSubmit = async (event) => {
    event.preventDefault();
      ...
      try {
        ...
        axios.put(`http://localhost:3001/PermitDriver/${id}`, formData)
          .then((res) => {
            console.log(res);
      ...
      <div className={styles.driverContainer} id="driverContainer">
        ...
        >
          ...
          <h1 className={styles.driverHead}>ড্রাইভার অনুমোদন ফর্ম</h1>
                  ...
                  <button type="button" className={styles.printDriverButton} onClick={handleCaptureAndConvert}>
                  অনুমোদন দিন
                </button>
          </div>
          ...
          <div className={styles.permitButtonContainer}>
            <button type="submit" className={styles.permitDriverButton} onClick={handleSubmit}>
              অনুমোদন দিন
            </button>
            <button type="submit" className={styles.notpermitDriverButton} onClick={handleReject}>
              এড়িয়ে যান
            </button>
          </div>
        </form>
